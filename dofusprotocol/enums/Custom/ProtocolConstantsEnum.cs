...
{
    public enum ProtocolConstantsEnum : long
    {
        MAP_CELL_COUNT = 560,

        MAX_LEVEL = 200,

        MAX_PRESTIGE_LEVEL = 206,
        ...
        USER_MAX_MOTD_LEN = 256,

        MAX_BULLETIN_LEN = 5120,

        USER_MAX_BULLETIN_LEN = 2560,
        ...
        MAX_FURNITURES_PER_PACKET = 40,

        MIN_LEVEL_HAVENBAG = 10,

        MAX_CRITERION_BY_DARE = 6,

        MIN_PLAYERS_FOR_GROUP_IDOLS = 3,

        MIN_DARE_JACKPOT_VALUE = 5000,

        DARE_CREATION_TAX = 1000,

        MIN_DARE_DURATION = 1,

        MAX_DARE_DURATION = 14,

        MAX_DARE_WINNERS = 5000,

        MAX_KAMA = 1000000000000,

        MAX_FOLLOWED_QUESTS = 5,
    }
}
